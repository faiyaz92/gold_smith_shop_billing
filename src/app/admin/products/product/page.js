  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="p-4 sm:p-6">
        <h2 className="text-xl font-bold mb-4 text-yellow-400">Manage Products</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 bg-gray-800/50 p-4 rounded-lg border border-gray-700">
          <input
            type="text"
            placeholder="Product Name"
            className="border border-gray-700 bg-gray-800 text-white p-2 rounded focus:outline-none focus:ring-1 focus:ring-yellow-500"
            value={form.name}
          ...
          <div className="col-span-full">
            ...
            <input 
              ...
              className="border border-gray-700 bg-gray-800 text-white p-2 rounded focus:outline-none focus:ring-1 focus:ring-yellow-500 w-full" 
              accept="image/*"
            />
            {imageUploading && <p className="text-sm text-yellow-400 mt-1">Uploading image...</p>}
          </div>
          {form.image && (
          ...
          <motion.button
            ...
            className={`px-4 py-2 rounded transition col-span-full font-medium ${
              imageUploading 
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-800 border-b border-gray-700">
                <th className="p-3 text-sm font-medium text-gray-400">Image</th>
                <th className="p-3 text-sm font-medium text-gray-400">Name</th>
                <th className="p-3 text-sm font-medium text-gray-400">Price</th>
                <th className="p-3 text-sm font-medium text-gray-400">Discount</th>
                <th className="p-3 text-sm font-medium text-gray-400">Category</th>
            ...
            <tbody>
              {products.length > 0 ? (
                products.map(p => (
                  <tr key={p.id} className="border-b border-gray-700 hover:bg-gray-800/70 transition-colors">
                    <td className="p-3">
                      <Image 
                        src={p.image} 
                        alt={p.name} 
                    ...
                    <td className="p-3 text-gray-400">{p.categoryName}</td>
                    <td className="p-3">
