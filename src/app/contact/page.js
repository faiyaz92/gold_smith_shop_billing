          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/cart" className="relative">
                <svg className="w-6 h-6 text-gray-700 hover:text-rose-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.1 5H19M7 13l-1.1 5M7 13l-1.1 5" />
                </svg>
                {cartCount > 0 && (
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Fragrance Avenue<br />Perfume District, NY 10001</p>
                  </div>
                </div>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-rose-600 text-white py-3 px-6 rounded-lg hover:bg-rose-700 focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  {isSubmitting ? (
                    <>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Yes, we offer a 30-day return policy for unopened products. Please contact us for return instructions.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Are your products cruelty-free?</h3>
              <p className="text-gray-600">Yes, all our fragrances are cruelty-free and not tested on animals. We source from ethical suppliers.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Can I track my order?</h3>
              <p className="text-gray-600">Yes, you&apos;ll receive a tracking number via email once your order ships. You can track it on our website.</p>
            </div>
          </div>
        </motion.div>
      </div>
